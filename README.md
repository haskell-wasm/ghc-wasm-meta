...
export CONF_CC_OPTS_STAGE2="-Wno-error=int-conversion -O3 -mcpu=mvp -mnontrapping-fptoint -msign-ext -mreference-types"
export CONF_CXX_OPTS_STAGE2="-fno-exceptions -Wno-error=int-conversion -O3 -mcpu=mvp -mnontrapping-fptoint -msign-ext -mreference-types"
